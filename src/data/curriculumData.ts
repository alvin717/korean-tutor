...
export const INITIAL_SRS_ITEMS: SrsItem[] = [
  // 1. 회화 표현 & 인사 (Phrases)
  {
    ...
    theme: 'daily',
    topikLevel: '기초',
    pronunciationRule: 'standard',
    romanization: 'an-nyeong-ha-se-yo',
    exampleKorean: '선생님, 안녕하세요!',
  ...
  },
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    phoneticSpelling: '[감사함니다]',
    ruleDescription: '비음화: ㅂ 뒤에 ㄴ이 오면 [ㅁ] 소리로 부드럽게 발음',
  ...
  },
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    conjugation: '주다 (기본형) → 주세요 (요청)',
    romanization: 'ju-se-yo',
    exampleKorean: '따뜻한 물 좀 주세요.',
    exampleEnglish: 'Please give me some warm water.',
    stability: 16.0,
    difficulty: 2.3,
    retrievability: 0.92,
    reps: 6,
  ...
  },
  {
    ...
    exampleKorean: '지하철역이 어디예요?',
    exampleEnglish: 'Where is the subway station?',
    stability: 7.2,
    difficulty: 4.0,
    retrievability: 0.78,
    reps: 4,
  ...
  },
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    phoneticSpelling: '[죄송함니다]',
    ruleDescription: '비음화 규칙: ㅂ 소리가 뒷글자 ㄴ 앞에서 [ㅁ]으로 변화',
    romanization: 'joe-song-ham-ni-da',
    exampleKorean: '늦어서 정말 죄송합니다.',
    exampleEnglish: 'I am so sorry for being late.',
    stability: 14.1,
    difficulty: 2.9,
    retrievability: 0.90,
    reps: 5,
  ...
  // 2. 문법 및 필수 조사 (Particles)
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    ruleDescription: '받침 O → "은" (학생은) / 받침 X → "는" (저는)',
    romanization: 'eun / neun',
    exampleKorean: '저는 한국어 학생입니다.',
    exampleEnglish: 'As for me, I am a Korean student.',
    stability: 3.2,
    difficulty: 7.8,
    retrievability: 0.62,
    reps: 4,
  ...
  },
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    ruleDescription: '받침 O → "이" (물이) / 받침 X → "가" (사과가)',
    romanization: 'i / ga',
    exampleKorean: '날씨가 참 좋아요.',
    exampleEnglish: 'The weather is really nice.',
    stability: 2.8,
    difficulty: 8.2,
    retrievability: 0.58,
    reps: 4,
  ...
  },
  {
    id: 'srs-9',
    word: '을 / 를',
    meaning: 'Object marker particles',
    partOfSpeech: '조사',
    posCategory: 'particle',
    theme: 'daily',
    topikLevel: '기초',
    pronunciationRule: 'standard',
    ruleDescription: '받침 O → "을" (밥을) / 받침 X → "를" (커피를)',
    romanization: 'eul / reul',
    exampleKorean: '저는 책을 읽어요.',
  ...
  },
  {
    id: 'srs-10',
    word: '에 / 에서',
    meaning: 'Location & Time particles (at / in / from)',
    partOfSpeech: '조사',
    posCategory: 'particle',
    theme: 'places',
    topikLevel: 'TOPIK I',
    pronunciationRule: 'standard',
    ruleDescription: '정적 위치·시간·목적지: "에" (집에 가요) / 동작이 일어나는 장소: "에서" (카페에서 공부해요)',
    romanization: 'e / e-seo',
    exampleKorean: '도서관에서 책을 읽어요.',
    exampleEnglish: 'I read a book at the library.',
    stability: 5.0,
    difficulty: 7.0,
    retrievability: 0.74,
    reps: 4,
  ...
  // 3. 발음 규칙별 특화 어휘 (Phonological Rules)
  {
    id: 'srs-11',
    word: '한국어',
    ...
    theme: 'work',
    topikLevel: '기초',
    pronunciationRule: 'liaison',
    phoneticSpelling: '[한구거]',
    ruleDescription: '연음 법칙: 앞 음절의 종성 "ㄱ"이 뒷 음절 초성 "ㅇ" 자리로 이동',
    romanization: 'han-gu-geo',
    exampleKorean: '한국어를 열심히 배워요.',
    exampleEnglish: 'I study Korean diligently.',
    stability: 19.5,
    difficulty: 2.2,
    retrievability: 0.95,
    reps: 7,
    lapses: 0,
    lastReviewDate: '2026-09-03',
  ...
  },
  {
    ...
    pronunciationRule: 'liaison',
    phoneticSpelling: '[으막]',
    ruleDescription: '연음 법칙: "ㅁ" 받침이 초성 "ㅇ" 자리로 넘어가 [으막]으로 발음',
    romanization: 'eu-mak',
    exampleKorean: '조용한 음악을 들어요.',
    exampleEnglish: 'I listen to quiet music.',
    stability: 15.0,
    difficulty: 2.8,
    retrievability: 0.90,
    reps: 5,
  ...
  },
  {
    ...
    theme: 'work',
    topikLevel: '기초',
    pronunciationRule: 'tensification',
    phoneticSpelling: '[학꾜]',
    ruleDescription: '된소리되기(경음화): 받침 "ㄱ" 뒤의 예사소리 "ㄱ"이 된소리 [ㄲ]으로 발음',
    romanization: 'hak-gyo',
    exampleKorean: '내일 아침에 학교에 가요.',
    exampleEnglish: 'I go to school tomorrow morning.',
    stability: 16.8,
    difficulty: 2.4,
    retrievability: 0.92,
    reps: 6,
  ...
  },
  {
    ...
    pronunciationRule: 'tensification',
    phoneticSpelling: '[식땅]',
    ruleDescription: '된소리되기(경음화): 받침 "ㄱ" 뒤의 "ㄷ"이 된소리 [ㄸ]으로 강화',
    romanization: 'sik-ddang',
    exampleKorean: '이 식당 음식이 맛있어요.',
    exampleEnglish: 'The food at this restaurant is delicious.',
    stability: 14.5,
    difficulty: 3.0,
    retrievability: 0.89,
    reps: 5,
  ...
  },
  {
    ...
    theme: 'emotions',
    topikLevel: 'TOPIK I',
    pronunciationRule: 'aspiration',
    phoneticSpelling: '[추카해요]',
    ruleDescription: '거센소리되기(격음화): 받침 "ㄱ"과 "ㅎ"이 합쳐져 거센소리 [ㅋ]으로 발음',
    romanization: 'chu-ka-hae-yo',
    exampleKorean: '생일을 진심으로 축하해요!',
    exampleEnglish: 'Happy birthday, congratulations!',
    stability: 11.2,
    difficulty: 3.5,
    retrievability: 0.84,
    reps: 4,
  ...
  },
  {
    ...
    theme: 'daily',
    topikLevel: '기초',
    pronunciationRule: 'neutralization',
    phoneticSpelling: '[꼳]',
    ruleDescription: '7종성 대표음: 음절 끝 "ㅊ" 받침은 대표음 [ㄷ] 소리로 닫혀 발음',
    romanization: 'kkot',
    exampleKorean: '봄에 예쁜 꽃이 펴요.',
    exampleEnglish: 'Pretty flowers bloom in spring.',
    stability: 13.0,
    difficulty: 3.4,
    retrievability: 0.87,
    reps: 5,
  ...
  },
  {
    ...
    pronunciationRule: 'neutralization',
    phoneticSpelling: '[옫]',
    ruleDescription: '7종성 대표음: "ㅅ" 받침 단독 발음 시 [ㄷ] 대표음으로 실현',
    romanization: 'ot',
    exampleKorean: '따뜻한 옷을 입으세요.',
    exampleEnglish: 'Please wear warm clothes.',
    stability: 17.0,
    difficulty: 2.2,
    retrievability: 0.93,
    reps: 6,
  ...
  // 4. 핵심 동작 동사 (Action Verbs)
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    conjugation: '가다 → 가요 (현재), 갔어요 (과거), 갈 거예요 (미래)',
    romanization: 'ga-da',
    exampleKorean: '지금 공항에 가요.',
    exampleEnglish: 'I am going to the airport right now.',
    stability: 22.0,
    difficulty: 1.8,
    retrievability: 0.96,
    reps: 7,
  ...
  },
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    conjugation: '오다 → 와요 (현재), 왔어요 (과거), 올 거예요 (미래)',
    romanization: 'o-da',
    exampleKorean: '친구가 한국에 와요.',
    exampleEnglish: 'A friend is coming to Korea.',
    stability: 20.5,
    difficulty: 2.0,
    retrievability: 0.95,
    reps: 7,
  ...
  },
  {
    ...
    pronunciationRule: 'tensification',
    phoneticSpelling: '[먹따]',
    conjugation: '먹다 → 먹어요 (현재), 먹었어요 (과거)',
    romanization: 'meok-da',
    exampleKorean: '점심에 비빔밥을 먹어요.',
    exampleEnglish: 'I eat bibimbap for lunch.',
    stability: 21.0,
    difficulty: 2.1,
    retrievability: 0.96,
    reps: 7,
  ...
  },
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    conjugation: '마시다 → 마셔요 (현재), 마셨어요 (과거)',
    romanization: 'ma-si-da',
    exampleKorean: '아침에 커피를 마셔요.',
  ...
  },
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    conjugation: '보다 → 봐요 (현재), 봤어요 (과거)',
    romanization: 'bo-da',
    exampleKorean: '주말에 한국 영화를 봐요.',
    exampleEnglish: 'I watch a Korean movie on weekends.',
    stability: 17.5,
    difficulty: 2.4,
    retrievability: 0.93,
    reps: 6,
  ...
  },
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    conjugation: '사다 → 사요 (현재), 샀어요 (과거)',
    romanization: 'sa-da',
    exampleKorean: '시장에서 모자를 샀어요.',
    exampleEnglish: 'I bought a hat at the market.',
    stability: 16.0,
    difficulty: 2.5,
    retrievability: 0.92,
    reps: 5,
  ...
  },
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    conjugation: '만나다 → 만나요 (현재), 만났어요 (과거)',
    romanization: 'man-na-da',
    exampleKorean: '오늘 저녁에 친구를 만나요.',
    exampleEnglish: 'I meet my friend this evening.',
    stability: 15.4,
    difficulty: 2.7,
    retrievability: 0.91,
    reps: 5,
  ...
  // 5. 핵심 상태 및 묘사 형용사 (Descriptive Adjectives)
  {
    id: 'srs-25',
    word: '맛있다',
    ...
    topikLevel: '기초',
    pronunciationRule: 'tensification',
    phoneticSpelling: '[마싣따 / 마딛따]',
    conjugation: '맛있다 → 맛있어요 (현재), 맛있었어요 (과거)',
    romanization: 'ma-sit-da',
    exampleKorean: '한국 김치가 정말 맛있어요.',
    exampleEnglish: 'Korean kimchi is really delicious.',
    stability: 19.8,
    difficulty: 2.1,
    retrievability: 0.95,
    reps: 6,
  ...
  },
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    conjugation: '크다 → 커요 (현재), 컸어요 (과거)',
    romanization: 'keu-da',
    exampleKorean: '이 가방은 너무 커요.',
    exampleEnglish: 'This bag is too big.',
    stability: 18.0,
    difficulty: 2.3,
    retrievability: 0.94,
    reps: 6,
  ...
  },
  {
    ...
    pronunciationRule: 'tensification',
    phoneticSpelling: '[작따]',
    conjugation: '작다 → 작아요 (현재), 작았어요 (과거)',
    romanization: 'jak-da',
    exampleKorean: '신발 사이즈가 조금 작아요.',
    exampleEnglish: 'The shoe size is a bit small.',
    stability: 14.2,
    difficulty: 3.1,
    retrievability: 0.89,
    reps: 5,
  ...
  },
  {
    ...
    pronunciationRule: 'aspiration',
    phoneticSpelling: '[조타]',
    ruleDescription: '거센소리되기: 받침 "ㅎ"과 "ㄷ"이 만나 [ㅌ] 소리로 발음',
    conjugation: '좋다 → 좋아요 (현재), 좋았어요 (과거)',
    romanization: 'jo-ta',
    exampleKorean: '오늘 기분이 정말 좋아요.',
    exampleEnglish: 'I feel really good today.',
    stability: 17.5,
    difficulty: 2.5,
    retrievability: 0.93,
    reps: 6,
  ...
  },
  {
    ...
    topikLevel: 'TOPIK I',
    pronunciationRule: 'standard',
    conjugation: '바쁘다 → 바빠요 (현재), 바빴어요 (과거)',
    romanization: 'ba-ppeu-da',
    exampleKorean: '요즘 시험 때문에 많이 바빠요.',
    exampleEnglish: 'I am very busy these days because of exams.',
    stability: 8.5,
    difficulty: 5.2,
    retrievability: 0.80,
    reps: 4,
  ...
  },
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    conjugation: '예쁘다 → 예뻐요 (현재), 예뻤어요 (과거)',
    romanization: 'ye-ppeu-da',
    exampleKorean: '서울의 야경이 참 예뻐요.',
    exampleEnglish: 'Seoul night view is really pretty.',
    stability: 16.2,
    difficulty: 2.6,
    retrievability: 0.92,
    reps: 5,
  ...
  // 6. 감탄사 & 실전 리액션 (Interjections)
  {
    id: 'srs-31',
    word: '대박!',
    meaning: 'Awesome! / Jackpot!',
    partOfSpeech: '감탄사',
    posCategory: 'interjection',
    theme: 'emotions',
    topikLevel: 'TOPIK I',
    pronunciationRule: 'standard',
    romanization: 'dae-bak!',
    exampleKorean: '우와, 이 음식 대박이에요!',
    exampleEnglish: 'Wow, this food is awesome!',
    stability: 8.8,
    difficulty: 2.0,
    retrievability: 0.85,
    reps: 4,
  ...
  },
  {
    ...
    exampleKorean: '내일 비가 온다고요? 진짜요?',
    exampleEnglish: 'It rains tomorrow? Really?',
    stability: 12.5,
    difficulty: 2.2,
    retrievability: 0.90,
    reps: 5,
  ...
  // 7. 실생활 장소 & 사물 명사 (Nouns by Situation)
  {
    id: 'srs-33',
    word: '화장실',
  ...
  },
  {
    ...
    topikLevel: '기초',
    pronunciationRule: 'standard',
    phoneticSpelling: '[지하철]',
    romanization: 'ji-ha-cheol',
    exampleKorean: '서울은 지하철이 매우 편리해요.',
    exampleEnglish: 'The subway in Seoul is very convenient.',
    stability: 14.8,
    difficulty: 2.8,
    retrievability: 0.90,
    reps: 5,
  ...
  },
  {
    ...
    pronunciationRule: 'standard',
    romanization: 'mul',
    exampleKorean: '시원한 물 한 잔 주세요.',
    exampleEnglish: 'Please give me a glass of cold water.',
    stability: 24.5,
    difficulty: 1.5,
    retrievability: 0.98,
    reps: 8,
  ...
  },
  {
    ...
    pronunciationRule: 'standard',
    romanization: 'bap',
    exampleKorean: '친구와 함께 밥을 먹어요.',
    exampleEnglish: 'I eat a meal with a friend.',
    stability: 23.0,
    difficulty: 1.6,
    retrievability: 0.97,
    reps: 8,
  ...
  },
  {
    ...
    pronunciationRule: 'tensification',
    phoneticSpelling: '[약꾹]',
    ruleDescription: '된소리되기: 받침 "ㄱ" 뒤의 "ㄱ"이 [ㄲ]으로 발음',
    romanization: 'yak-guk',
    exampleKorean: '감기약 사러 약국에 가요.',
    exampleEnglish: 'I go to the pharmacy to buy cold medicine.',
    stability: 9.0,
    difficulty: 4.8,
    retrievability: 0.82,
    reps: 4,
  ...
  },
  {
    ...
    exampleKorean: '머리가 아파서 병원에 왔어요.',
    exampleEnglish: 'My head hurts so I came to the clinic.',
    stability: 8.2,
    difficulty: 5.0,
    retrievability: 0.80,
    reps: 4,
  ...
  },
  {
    ...
    exampleKorean: '길을 잃었어요. 도와주세요!',
    exampleEnglish: 'I am lost. Please help me!',
    stability: 6.8,
    difficulty: 4.5,
    retrievability: 0.76,
    reps: 3,
  ...
  },
  {
    ...
    exampleKorean: '선생님께 질문을 드려요.',
    exampleEnglish: 'I ask the teacher a question.',
    stability: 16.5,
    difficulty: 2.5,
    retrievability: 0.92,
    reps: 6,
